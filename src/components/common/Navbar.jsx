    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
              ...
              <li key={index}>
                {link.title === "Catalog" ? (
                  ...
                  >
                    ...
                    {/* Dropdown Menu */}
                    <div className="invisible absolute left-[50%] top-[50%] z-[1000] flex w-[200px] translate-x-[-50%] translate-y-[3em] flex-col rounded-lg bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-150 group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 lg:w-[300px] shadow-xl">
        ...
        <div className="hidden items-center gap-x-4 md:flex">
          ...
          {token === null && (
            <Link to="/login">
              <button className="rounded-[8px] border border-richblack-700 bg-richblack-800 px-[12px] py-[8px] text-richblack-100 hover:border-richblack-500 transition-colors">
                Log in
              </button>
            </Link>
          )}

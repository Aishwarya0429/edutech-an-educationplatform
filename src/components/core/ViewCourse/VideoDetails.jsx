...
const VideoDetails = () => {
  ...
  const handleLectureCompletion = async () => {
    ...
    const res = await markLectureAsComplete(
      { courseId: courseId, subSectionId: subSectionId, subsectionId: subSectionId },
      token
    );
    if (res) {
  ...
  return (
    <div className="flex flex-col gap-5 text-white">
      {!videoData ? (
        ...
        <div className="relative overflow-hidden rounded-md">
          ...
          >
            ...
            {/* Render Overlay When Video Ends */}
            {videoEnded && (
              <div
                style={{
                  backgroundImage:
      ...
      <h1 className="mt-4 text-3xl font-semibold text-richblack-5">
        {videoData?.title}
      </h1>
